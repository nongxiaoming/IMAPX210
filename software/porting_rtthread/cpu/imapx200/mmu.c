...
#define _MMUTT_STARTADDRESS     (0x4A000000)
...
//	mmu_setmtt(0x60000000,0x67f00000,0x60000000,RW_NCNB); //SFR
    ...
    mmu_setmtt(0x00000000, 0xFFFFFFFF, 0x00000000, RW_NCNB);
    mmu_setmtt(0x00000000, 0x00100000, 0x40000000, RW_NCNB);
	...
	rt_kprintf(" mmu enable \r\n");
    mmu_enable();
	rt_kprintf(" ICache enable \r\n");
    /* ICache enable */
    mmu_enable_icache();
	rt_kprintf(" DCache enable \r\n");
